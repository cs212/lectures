...
public class WidgetDemo {
	...
	public static void main(String[] args) {
		/*
		 * STATIC - Since this method is static, we can access it when
		 * there are no instances created. That is why static members are
		...
		/*
		 * INSTANCE - The following are actual objects, or instances of
		 * the Widget class. They have their own instance attributes, but
		 * share class attributes.
		 *
		 * DECLARATION - We have declared the identifiers for these
		 * elements, but memory has not yet been reserved. Any access
		...
		/*
		 * DEFINITION - We are reserving memory with the "new" keyword,
