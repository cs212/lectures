...
public class FindDemo {
     ...
     *
     * Note: See the {@link Arrays} class for {@link Arrays#sort(Object[])}
     * and {@link Arrays#binarySearch(Object[], Object)} methods too. You do
     * not need to convert to a list to do this.
     */
    private static void listDemo() {

        /*
         * Make sure to use the helper methods in Collections. It is faster
         * to use Collections.addAll() to add elements to a list. And, there
