...
public class HelloServer {
	...
	public static class HelloServlet extends HttpServlet {
		...
		protected void doGet(
			 ...
			 *
			 * Some browsers are smart enough to not load Javascript found within
			 * the URL request... so these examples may no longer work. We can
			 * disable this security feature momentarily using:
			 *
