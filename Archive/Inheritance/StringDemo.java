/**
 * This class demonstrates the {@link String} class, and how it is optimized
 * by Java for efficiency. It also illustrates the dangers of using the ==
...
public class StringDemo {
	...
	public static void main(String[] args) {
		...
		/*
		 * Even though we asked Java to create two of the String objects in
		 * new memory, all of the hash codes appear to be the same!
		 */
		 ...
		 * behavior---if the String objects have the same value, they should
		...
		/*
		 * Note that equals() and == no longer do the same operation. The
		 * String class overrode equals() to compare by content. But, the ==
		 * operator still compares by memory location!
		 */
		...
		/*
		 * Be very aware of the difference between equals() and == when you
		 * are doing any kind of comparison. Most of the time, classes will
		 * override equals() to compare by value, not memory location. But the
