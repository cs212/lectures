 ...
 * interfaces, nested classes, Generic syntax, and how to use these elements
 * to change how a list of objects is sorted.
 *
...
public class SortDemo {
	 ...
	 * class by implementing the {@link Comparable} interface. Since this
	 * class does not depend on any {@link SortDemo} instance members, we can
	 * make this class {@code static}.
	 */
	...
	/**
	 * This class {@link Comparator} to change how {@link #Widget} objects
	 * are sorted.
	 */
	private static class WidgetComparator implements Comparator<Widget> {
		/**
		 * Will sort {@link Widget} objects by the length of the name instead
		 * of the id.
		 */
		@Override
	 ...
	 *
	 * @param c the collection to be printed to the console
	 */
	...
	/**
	 * Demonstrates how to sort the {@link ArrayList} of {@link #Widget}
	 * objects using the {@link Comparable} and {@link Comparator} interfaces
	 * and the {@link Collections#sort(java.util.List)} methods.
	 *
	 * @param args unused
	 *
	 * @see {@link Comparable}
