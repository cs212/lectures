...
/**
 * This class demonstrates the {@link Object} class, that arrays are objects
 * and hence inherit those methods.
 *
...
public class ObjectDemo {
	...
	/**
	 * This method demonstrates that we can create an actual {@link Object}
	 * if we wanted to, and access various properties about that object.
	 *
	 * @see {@link Object}
	 */
	...
	/**
	 * This method demonstrates that any class, including this one, is an
	 * object and hence has access to the methods in {@link Object}. We have
	 * not created a constructor, but we can still create an object of this
	 * class! The default constructor in the {@link Object} class will be
	 * called in this case.
	 *
	 * @see {@link Object}
	 */
	...
	/**
	 * The default {@code equals())} method in the {@link Object} class
	 * compares hash codes, so if the hash codes are equal then the objects
	 * are equal. By default, the {@code ==} operator does the same.
	 */
	...
	/**
	 * Runs all of the demos. Comment out the demos if you want to run them
	 * one at a time.
	 *
	 * @param args unused
	 */
